/**
 * Core for Shower HTML presentation engine, modified for Ponyshow
 * @copyright 2010–2014 Vadim Makeev, http://pepelsbey.net
 * @copyright 2015 TZ Martin, http://www.semanticpress.com
...
window.shower = (function(window, document, undefined) {
  ...
  shower.toggleSlideNumber = function() {
	...
	* @param {string}
	*/
	shower.enableKey = function(_key) {
		delete this.disabledKeys[_key];
	};
		  ...
		  break;
			...
			case 27: // Esc	
				...
				if (shower.isSlideMode()) {
					e.preventDefault();
					shower.enterListMode();
					fireEvent({event:"setWindowState",data:"maximized"});
				}
